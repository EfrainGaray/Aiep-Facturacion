    ...
    <hr />
     <div class="row">
        ...
        <div class="col-4 text-right">
            ...
            <asp:TextBox ID="txtFInicial" runat="server" TextMode="DateTime" CssClass="form-contro"></asp:TextBox>
            <label>Fecha Inicial:</label>
            <asp:TextBox ID="txtFFinal" runat="server" TextMode="DateTime" CssClass="form-contro"></asp:TextBox>
            <asp:LinkButton  id="buscarxFecha" runat="server" OnClick="buscarxFecha_Click" CssClass="" >
                        <svg width="2em" height="2em" viewBox="0 0 16 16" class="bg btn-light" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Herramientas">
                <ItemTemplate>
                    ...
                    <asp:LinkButton  id="anularDocumento" runat="server" OnClick="anularDocumento_Click" CssClass="" data-folio='<%# Eval("Folio") %>'>
